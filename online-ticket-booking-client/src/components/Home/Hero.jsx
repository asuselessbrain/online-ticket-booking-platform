...
const Hero = () => {
    return (
        <section className="bg-linear-to-b from-slate-50 to-white py-12 px-4">
            <div className="max-w-[1400px] mx-auto grid gap-8 items-center lg:grid-cols-2">
                <div className="p-4">
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-5 gap-3 items-center" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button type="submit" className="w-full md:w-auto bg-linear-to-r from-teal-400 to-blue-500 text-white rounded-lg px-4 py-2 font-semibold">Search Tickets</button>
                    </form>

                    <div className="mt-4 flex gap-3">
                        <button className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold">Become a Vendor</button>
                        <button className="rounded-lg px-4 py-2 text-sm text-slate-800">How it works</button>
                    </div>
                </div>

                <div aria-hidden="true" className="flex flex-col gap-4">
                    <div className="rounded-xl overflow-hidden shadow-lg gitbg-linear-to-r from-emerald-200 to-sky-400">
